...
Asc это сортировка по возрастанию, можно не писать потому что по умолчанию так и сортирует, desc по убыванию
Лимит 5 это самые дорогие
Варчар это количество символов
